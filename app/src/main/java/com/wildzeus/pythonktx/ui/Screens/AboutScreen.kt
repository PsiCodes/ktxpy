...
topBar =
{
    TopAppBar(title = { Text(text = "About", fontFamily =FontFamily(Font(R.font.roboto_condensed_bold))) },
        ...
        actions = {
            Icon(painter = painterResource(id = R.drawable.code_blocks_fill0_wght400_grad0_opsz48), contentDescription = null)
        })
}
){
    Column(modifier = Modifier.padding(it))
    {
        ...
        Divider(modifier = Modifier.padding(12.dp))
        Text(text = "Special Thanks To Rosmoe,Roumen Petrov & hzy3774", fontSize = 13.sp, fontFamily = FontFamily(Font(R.font.roboto_condensed_bold)), modifier = Modifier.padding(12.dp,6.dp,2.dp,6.dp))
        Divider(modifier = Modifier.padding(12.dp))
    }
}}
